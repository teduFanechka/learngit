...
public class Checkresult implements java.io.Serializable {
	...
	private String crCheckres;// 检查来源1
	private String crCheckno;// 检查流水号2
	private String crCaseno;// 病案号3
	private String crHospno;// 住院号/门诊号4
	private String crDeptcode;// 科室编码5
	private String crDept;// 科室名称6
	private String crRoom;// 房间号7
	private String crBed;// 床位号8
	private String crClinicdiag;// 临床诊断9
	private String crCheckposi;// 检查部位10
	private String crModel;// 标本号11
	private String crModeltype;// 标本种类12
	private String crItemcode;// 项目编码13
	private String crItemname;// 项目名称14
	private String crTool;// 使用仪器15
	private String crCheckresult;// 检查结果16
	private String crPtsname;// 患者姓名17
	private String crPtssex;// 患者性别18
	private String crAge;// 年龄19
	private String crIdnum;// 身份证号20
	private String crHealthcard;// 医保卡号21
	private String crSenddate;// 送检日期22
	private String crCheckdate;// 检验日期23
	private String crReportdate;// 报告日期24
	private String crSenddoc;// 送检医生编码25
	private String crSenddocno;// 送检医生名称26
	private String crCheckdoc;// 检验医生编码27
	private String crCheckdocno;// 检验医生名称28
	private String crAuditdoc;// 审核医生编码29
	private String crAuditdocno;// 审核医生名称30
	private String crComment;// 备注31
