...
public class Warehouse implements java.io.Serializable {
	...
	private String whCode;//1库房编码
	private String whName;//2库房名称
	private String whMancode;//3负责人编码
	private String whManname;//4负责人姓名
	private String whLocation;//5库房位置
	private String whStatus;//6状态
